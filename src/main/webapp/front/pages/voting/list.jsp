                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">投票电影</label>
                          <div class="layui-input-inline">
                              <input type="text" name="dianyingIdStart" id="dianyingIdStart"  lay-skin="integer"   placeholder="投票电影开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="dianyingIdend"   id="dianyingIdend"    lay-skin="integer|dianyingIdend"   placeholder="投票电影结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
